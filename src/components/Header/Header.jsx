...
const Header = () => {
  ...
  const {isOpen : isNotification, toggleMenu : notificationMenu, dropDownRef : notificationRef} = useDropdownPopupControl()
  return (
    <>
...
<a href="#" className="dropdown-toggle nav-link" data-toggle="dropdown" onClick={notificationMenu}>
  <i className="fe fe-bell"></i> <span className="badge badge-pill">3</span>
</a>
{ isNotification && 
<div className="dropdown-menu notifications d-block" style={{ transform : "translate(-298px, 0px)"}}>
...
{ isOpen && <div className="dropdown-menu d-block" style={{ transform : "translate(-139px, 0px)"}}>
