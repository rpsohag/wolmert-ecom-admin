											...
											<tbody>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialities1} alt="Speciality" />
															</a>
												...
												<tr>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialities2} alt="Speciality" />
															</a>
												...
												<tr>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialities3} alt="Speciality" />
															</a>
												...
												<tr>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialities4} alt="Speciality" />
															</a>
												...
												<tr>
													...
													<td>
														<h2 className="table-avatar">
															<a href="profile.html" className="avatar avatar-sm mr-2">
																<img className="avatar-img" src={Specialities5} alt="Speciality" />
															</a>
